...
Start-Transcript -path "$($pathToTranscript)Evaluate-ssd_mobilenet_v1_muscima_150x300_pretrained.txt" -append
echo "Validate with ssd_mobilenet_v1_muscima_150x300_pretrained"
python object_detection/eval.py --logtostderr --pipeline_config_path=C:\Users\alpa\Repositories\MusicObjectDetector-TF\MusicObjectDetector\configurations\ssd_mobilenet_v1_muscima_150x300_pretrained.config --checkpoint_dir=C:\Users\alpa\Repositories\MusicObjectDetector-TF\MusicObjectDetector\data\training-checkpoints-ssd_mobilenet_v1_muscima_150x300_pretrained --eval_dir=C:\Users\alpa\Repositories\MusicObjectDetector-TF\MusicObjectDetector\data\validation-checkpoints-ssd_mobilenet_v1_muscima_150x300_pretrained
Stop-Transcript
