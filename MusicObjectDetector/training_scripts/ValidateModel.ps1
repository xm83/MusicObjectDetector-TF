...
# $configuration = "faster_rcnn_resnet50_pretrained_with_stafflines_dimension_clustering2_rms"
## $configuration = "faster_rcnn_resnet50_pretrained_reduced_classes_with_stafflines_dimension_clustering2_rms"
## $configuration = "faster_rcnn_resnet50_pretrained_without_stafflines_dimension_clustering2_rms.config"
...
# $configuration = "faster_rcnn_inception_resnet_v2_atrous_pretrained_without_stafflines_dimension_clustering2_rms"
...
$configuration = "rfcn_resnet50_pretrained_dim_clust2_rms_without_staff_lines"
## $configuration = "rfcn_resnet50_pretrained_reduced_classes_dim_clust2_rms"
## $configuration = "rfcn_resnet50_pretrained_reduced_classes_dim_clust2_rms_without_staff_lines"
