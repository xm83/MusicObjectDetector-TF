...
Start-Transcript -path "$($pathToTranscript)Transcript-ssd_inception_v2_muscima_150x300_pretrained.txt" -append
echo "Train with ssd_inception_v2_muscima_150x300_pretrained"
python object_detection/train.py --logtostderr --pipeline_config_path=C:\Users\alpa\Repositories\MusicObjectDetector-TF\MusicObjectDetector\configurations\ssd_inception_v2_muscima_150x300_pretrained.config --train_dir=C:\Users\alpa\Repositories\MusicObjectDetector-TF\MusicObjectDetector\data\training-checkpoints-ssd_inception_v2_muscima_150x300_pretrained
Stop-Transcript