...
python object_detection/train.py --logtostderr --pipeline_config_path="$($pathToSourceRoot)/configurations/$($configuration).config" --train_dir="\\MONSTI\MusicObjectDetector-TF_Results\checkpoints-$($configuration)-train"
Stop-Transcript
